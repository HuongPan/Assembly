		...
		.if uMsg == WM_COMMAND
			...
			.if lParam == 0
				...
				.elseif ax == ID_GenButC
					...
					invoke DestroyWindow,button1
					invoke CreateWindowEx,WS_EX_CLIENTEDGE, addr butClass, addr butCon, WS_CHILD or WS_VISIBLE or BS_DEFPUSHBUTTON, Wei,10,50,30,hWnd, butC, hIns,NULL
					mov button1, eax
			...
			.else
				...
				.elseif ax == butP
					invoke SendMessage,hWnd,WM_COMMAND, ID_SusThr,0
					invoke SendMessage,hWnd,WM_COMMAND, ID_GenButC,0
				.elseif ax == butC
					invoke SendMessage,hWnd,WM_COMMAND, ID_GenButP,0
					invoke SendMessage,hWnd,WM_COMMAND, ID_ResuThr,0
				.endif
			.endif
